                        ...
                        <div className="flex flex-col min-h-screen">
                            ...
                            {isLoading ? (
                                ...
                                <div className="animate-fade-in w-full">
                                    ...
                                    <div className="hidden lg:flex w-full p-8 gap-10 items-start">
                                        {/* Anime Poster (aspect-[3/4]) */}
                                        ...
                                        <div className={`flex-1 flex flex-col justify-start text-gray-900 dark:text-white pt-2 ${lang === 'ar' ? 'text-right' : 'text-left'}`}>
                                            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-black leading-tight mb-5 drop-shadow-sm group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">
                                                {renderEmojiContent(animeTitle)}
                                            </h1>
                                            ...
                                            <div className="bg-gray-50 dark:bg-[#1a1a1a] p-4 md:p-6 rounded-none border border-gray-100 dark:border-[#2a2a2a] mb-8 shadow-sm">
